export default {
  ...
  row2: [
    ...
    { style: { transform: 'translateX(0.5rem)' }, id: 5 },
    { style: { transform: 'translateX(-0.5rem)' }, id: 6 },
  ...
  row4: [
    ...
    { style: { transform: 'translateX(0.5rem)' }, id: 14 },
    { style: { transform: 'translateX(-0.5rem)' }, id: 15 },
